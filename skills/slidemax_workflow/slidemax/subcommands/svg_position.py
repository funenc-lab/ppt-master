...
CLI_PROG = "python3 skills/slidemax_workflow/scripts/slidemax.py svg_position_calculator"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  %(prog)s analyze example.svg
  %(prog)s interactive
  %(prog)s from-json config.json
  %(prog)s calc bar --data "east:185,south:142"
  %(prog)s calc pie --data "A:35,B:25,C:20"
  %(prog)s calc line --data "0:50,10:80,20:120"
        ''',
    )
