...
CROP_PROG = "python3 skills/slidemax_workflow/scripts/slidemax.py crop_images"
EMBED_ICONS_PROG = "python3 skills/slidemax_workflow/scripts/slidemax.py embed_icons"
FIX_ASPECT_PROG = "python3 skills/slidemax_workflow/scripts/slidemax.py fix_image_aspect"
EMBED_IMAGES_PROG = "python3 skills/slidemax_workflow/scripts/slidemax.py embed_images"
