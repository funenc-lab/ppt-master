...
`scripts/slidemax.py image_generate` is the canonical image-generation entry point.
...
- Command: `../../scripts/slidemax.py doubao_i2v_task`
...
```bash
python3 skills/slidemax_workflow/scripts/slidemax.py doubao_i2v_task create \
...
```bash
python3 skills/slidemax_workflow/scripts/slidemax.py doubao_i2v_task run \
  "Fast drone flight through a canyon" \
  --image-url "https://example.com/reference.png" \
...
```bash
python3 skills/slidemax_workflow/scripts/slidemax.py doubao_i2v_task status <task_id>
```

Download from a signed video URL:

```bash
python3 skills/slidemax_workflow/scripts/slidemax.py doubao_i2v_task download \
