...
```bash
python3 skills/slidemax_workflow/scripts/slidemax.py download_stock_image <项目路径> \
  --provider pexels \
...
```bash
python3 skills/slidemax_workflow/scripts/slidemax.py register_stock_image <项目路径> \
  --provider unsplash \
