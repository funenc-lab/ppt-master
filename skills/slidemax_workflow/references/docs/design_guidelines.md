...
- 发布/后处理：推荐使用统一后处理工具 `skills/slidemax_workflow/scripts/slidemax.py finalize_svg`，已包含文本扁平化功能：
  ```bash
...
本项目提供 **预置图标库**，位于 `skills/slidemax_workflow/templates/icons/`，包含 640+ 图标，风格统一，可直接复用。

- 图标使用说明：[`../../templates/icons/README.md`](../../templates/icons/README.md)
- 图标文件目录：`skills/slidemax_workflow/templates/icons/`
